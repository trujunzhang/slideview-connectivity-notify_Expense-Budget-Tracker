...
import 'package:ieatta/screens/home/income_page_screen.dart';
...
class _BuildIncomeTilesState extends State<BuildIncomeTiles> {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (incomeList.length <= 5) widget.itemCount = incomeList.length;
    return Container(
            ...
            onTap: () {
              if (widget.flag == 1) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => IncomePageScreen(
                        index: index,
                      ),
                    ));
              }
